...
int main(){
    ...
    for (i=0; i<5; i++){
        printf("Give #%d value for 1st array: \n", i+1, arr1[i]);
        scanf("%d", &arr1[i]);
    }
    for (i=0; i<5; i++){
        printf("Give #%d value for 2nd array: \n", i+1, arr2[i]);
        scanf("%d", &arr2[i]);
    }
    for (i=0; i<5; i++){
...
int main(){
    ...
    for (i=0; i<2; i++){
        for (j=0; j<3; j++){
            printf("Give element [%d][%d] of matrix: \n", i, j);
            scanf("%d", &a[i][j]);
        }
    }
    printf("Matrix is: \n");
...
int main(){
    float average;
    int size;
    float marks[5]={10.0, 15.0, 20.0, 30.0, 45.0};
    size=sizeof(marks)/sizeof(marks[0]);
    average=avg(marks, size);
    printf("Average is: %f\n", average);
    printf("Inside main, size of given array in bytes is: %d\n", sizeof(marks));
    printf("Inside main, size of 1st array element in bytes is: %d\n", sizeof(marks[0]));
}


float avg(float marks[], int size){
    int i;
    ...
    average=sum/size;
    printf("Inside avg, size of given array in bytes is: %d\n", sizeof(marks));
    return average;
}
*/
/*---------------------------------------------------------*/
...
void choice_and_execution();

int main(){
    choice_and_execution();
    return;
}
...
void choice_and_execution(){
    int desicion;
    float a, b;
    void (*fptr[N])(float, float)={add, sub, multi, div};
